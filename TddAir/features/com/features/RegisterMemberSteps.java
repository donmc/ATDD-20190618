...
public class RegisterMemberSteps {
	...
	@Then("^member ytd Mile is (\\d+)$")
	public void member_ytd_Mile_is(int ytdMiles) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
	...
	@Then("^recieve error message \"([^\"]*)\"$")
	public void recieve_error_message(String message) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
}
